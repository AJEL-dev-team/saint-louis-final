    ...
    <div className="mx-auto max-w-7xl px-6 lg:px-8 py-14">
        ...
        <div
            ...
            <article
                ...
                <img src="./images/119.jpg" alt="" className="absolute inset-0 -z-10 h-full w-full object-cover" />
                ...
                <h3 className="mt-3 text-lg font-semibold leading-6 text-white hover:underline">
                    <a href="/tech-blog/post1"><span className="absolute inset-0"></span>
                        Lorem ipsum dolor sit amet consectetur adipisicing.
                    </a>
                </h3>
                <h4 className='text-gray-300 text-xs pt-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo, temporibus quis sint</h4>
            </article>
            <article
                className="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 dark:bg-gray-700 px-8 py-8 pb-8 pt-80 sm:pt-48 lg:pt-80">
                <img src="./images/119.jpg" alt="" className="absolute inset-0 -z-10 h-full w-full object-cover" />
