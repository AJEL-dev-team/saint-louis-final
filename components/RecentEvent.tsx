...
export default function RecentEvent() {
  ...
  const event = {
    ...
    description:
      "Join us for our annual fundraiser to support the parish's various initiatives.",
    date: "15th September",
    time: "5:00 PM",
    image:
    ...
    <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
      <div className="flex flex-col md:flex-row rounded overflow-hidden shadow-lg bg-white">
        ...
        <div className="md:w-2/3 p-6 flex flex-col justify-between">
          <div>
            <div className="text-sm text-[#ffffff] bg-[#2e3192] inline-block px-3 py-1 mb-4 mr-3 rounded-md">
              Upcoming Event
            </div>
            <a
              href={event.link}
              className="font-semibold text-2xl text-[#2e3192] hover:text-[#b59316] transition duration-300"
            >
              {event.title}
            </a>
