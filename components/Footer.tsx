  ...
  return (
    <footer className="bg-[#f0f0f0] text-[#231f20]">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-8 flex flex-wrap justify-between">
        ...
        {/* Home Section */}
        <div className="p-5">
          <div className="text-xs uppercase text-[#231f20] font-medium mb-2">
            Home
          </div>
          <Link
            href="/mass"
            className="block my-2 text-[#2e3192] hover:text-[#b59316] font-work-sans"
          >
            Calender
          </Link>
          <Link
        ...
        <div className="p-5">
          ...
          <Link
            href="mailto:contact@parish.com"
            className="block my-2 text-[#2e3192] hover:text-[#b59316] font-work-sans"
          >
            contact@parish.com
          </Link>
      ...
      <div className="bg-[#231f20] text-[#b59316] py-4 text-center">
        <p className="text-sm font-work-sans">
          © {new Date().getFullYear()} Parish Name. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
