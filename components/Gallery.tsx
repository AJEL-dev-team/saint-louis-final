        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {galleryItems.map((item) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-[#2e3192] bg-opacity-30 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  <h4 className="text-xl font-bold text-[#b59316]">
                    {item.title}
                  </h4>
                  {item.description && (
